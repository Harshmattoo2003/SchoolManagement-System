                                    ...
                                    <nav className="f4" style={{backgroundColor:"#282c34",position:"fixed",zIndex:"1050",top:"0",left:"0",width:"100%",boxShadow:"0px 4px 6px rgba(0,0,0,0.1)",height:"60px"}}>
                                        ...
                                        <div style={{backgroundColor:"#282c34",display:"flex",justifyContent:"space-between",width:"30%"}}>
                                            {/* <select style={{width:"40px",backgroundColor:"#282c34",border:"none"}}  className="text-light languageselectpicker form-control search-form search-form3 langselect" value={lang} onChange={handleLanguageChange} required>
                                             ...
                                             <a  className="pt-3" data-placement="bottom"  data-toggle="tooltip" title="Whatsapp" href={`https://wa.me/${user[0]?.mobileno}`} target="_blank" rel="noreferrer" >
                                            ...
                                            {open1 && (
                                                <div className="text-start pt-2 pe-2" style={{position:"fixed",padding:"10px",top:"8.5%",right:"0%",border:"solid 0px",borderRadius:"10px",backgroundColor:"white",width:"19%",boxShadow:"0px 4px 6px rgba(0,0,0,0.5)"}}>
                                                    <div style={{display:"flex"}}>
                                                        <p><Link to="/student1"> <img   className="" width="90px" height="90px" src={user[0]?.image? user[0].image:"Noimage"} alt="smart"/></Link></p>
                                                        <div className="ms-2">
                                                    ...
                                                    <div style={{display:"flex",justifyContent:"space-between"}}>
                                                        <button style={{backgroundColor:"white"}} className="btn ps-0" type="button" onClick={()=>window.location.href="/admin"} >👨🏻‍💼 Profile</button>
                ...
                <div className="text-start " style={{backgroundColor:"#282c34",listStyleType:"none"}}>
                    ...
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu2`} className={`collapse ${open===2?"show":""}m-0 p-0 `} style={{height:"25px"}}>
                            ...
                            <button  className="ps-3 pt-1  pe-3 m-0 l17" onClick={()=>nav("/admin22")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin22"?"cyan":""}}>- Student Admission</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin23")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin23"?"cyan":""}}>- Bulk Delete</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin24")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin24"?"cyan":""}}>- Student Category</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin25")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin25"?"cyan":""}}>- Student House</button>
                        </div>
                    </div>
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu3`} className={`collapse ${open===3?"show":""}m-0 p-0`} style={{height:"25px"}}>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin31")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin31"?"cyan":""}}>- Fees Group</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin32")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin32"?"cyan":""}}>- Fees Type</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin33")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin33"?"cyan":""}}>- Fees Master</button>
                        </div>
                    </div>
                    {/* <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu4`} className={`collapse ${open===4?"show":""}m-0 p-0`} style={{height:"25px"}}>
                            <button  className="ps-3 pt-1  pe-3 m-0 l17" onClick={()=>nav("/admin41")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin41"?"cyan":""}}>-</button>
                        </div>
                    </div> */}
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu5`} className={`collapse ${open===5?"show":""}m-0 p-0`} style={{height:"25px"}}> 
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin51")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin51"?"cyan":""}}>- Expense Head</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin52")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin52"?"cyan":""}}>- Add Expense</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin53")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin53"?"cyan":""}}>- Search Expense</button>
                        </div>
                    </div>
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu6`} className={`collapse ${open===6?"show":""}m-0 p-0`} style={{height:"25px"}}>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin61")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin61"?"cyan":""}}>- Exam Group</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin62")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin62"?"cyan":""}}>- Exam Name</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin63")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin63"?"cyan":""}}>- Design Exam</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin64")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin64"?"cyan":""}}>- Exam Schedule</button>
                        </div>
                    </div>
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu7`} className={`collapse ${open===7?"show":""}m-0 p-0`} style={{height:"25px"}}>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin71")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin71"?"cyan":""}}>-Student Attendance</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin72")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin72"?"cyan":""}}>-Attendance By Date</button>
                        </div>
                    </div>
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu8`} className={`collapse ${open===8?"show":""}m-0 p-0`} style={{height:"25px"}}>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin81")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin81"?"cyan":""}}>- Content Type</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin82")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin82"?"cyan":""}}>- Upload Content</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin83")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin83"?"cyan":""}}>- Content List</button>
                        </div>
                    </div>
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu9`} className={`collapse ${open===9?"show":""}m-0 p-0`} style={{height:"25px"}}>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin91")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin91"?"cyan":""}}>- Add Homework</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin92")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin92"?"cyan":""}}>- Homework List</button>
                        </div>
                    </div>
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                    ...
                    <div className="dropdown " style={{width:"100%",backgroundColor:"#282c34"}} >
                        ...
                        <div id={`menu11`} className={`collapse ${open===11?"show":""}m-0 p-0`} style={{height:"25px"}}>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin111")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin111"||loc.pathname==="/admin111/admin1111"||loc.pathname==="/admin111/admin1112"||loc.pathname==="/admin111/admin1113"?"cyan":""}}>-Student Information</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin112")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin112"?"cyan":""}}>-Attendance</button>
                            <button  className="ps-3 pt-1 pe-3 m-0 l17" onClick={()=>nav("/admin113")} style={{width:"100%",backgroundColor:"#242124",height:"30px",border:"none",color:loc.pathname==="/admin113"?"cyan":""}}>-Homework</button>
                        </div>
                    </div>
                </div>
            </div>
