...
const News4=()=>{
    const [data,setData]=useState([
        {id:1,heading:"Heading 41",news:"news 41"},
        {id:2,heading:"Heading 42",news:"news 42"},
        {id:3,heading:"Heading 43",news:"news 43"}
    ]);
    ...
    return(
        <div>
            ...
            <h2 className="text-start ps-5 pt-3 text-secondary">News 4</h2>
            ...
            <div>
                <ul style={{listStyleType:"none"}}>
                    {d.map((d)=>(
                        <li className="mb-3 me-4 news2" style={{borderStyle:"solid",height:300}} key={d.id}>
