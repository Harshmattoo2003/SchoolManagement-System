...
const News2=()=>{
    const [data,setData]=useState([
        {id:1,heading:"Heading 21",news:"news 21"},
        {id:2,heading:"Heading 22",news:"news 22"},
        {id:3,heading:"Heading 23",news:"news 23"}
    ]);
    ...
    return(
        <div>
            ...
            <h2 className="text-start ps-5 pt-3 text-secondary">News 2</h2>
